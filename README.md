...
######      user2@example.comは過去に店舗(shop_id = 4)を予約したがレビューは投稿していないユーザーとしてログインできる。これから口コミを作成するユーザー。
######      パスワードは"password"
######      
###### 管理ユーザーとしての利用
######      localhost/admin/loginにアクセスしadmin01@example.comでログイン。パスワードは"administrator"。
