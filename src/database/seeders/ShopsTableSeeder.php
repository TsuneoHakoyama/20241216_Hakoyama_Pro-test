...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'image' => 'storage/images/shops/sushi.jpg',
        ];
        ...
        $param = [
            ...
            'image' => 'storage/images/shops/yakiniku.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '戦慄',
            ...
            'image' => 'storage/images/shops/izakaya.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => 'ルーク',
            ...
            'image' => 'storage/images/shops/italian.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '志摩屋',
            ...
            'image' => 'storage/images/shops/ramen.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '香',
